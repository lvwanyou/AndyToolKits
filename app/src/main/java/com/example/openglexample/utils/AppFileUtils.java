...
/**
 * Created by xiezhaofei on 2018/1/16.
 */
...
public class AppFileUtils {
    ...
    public static String getInnerCache(Context context) {
    ...
    public static String getAssetBundle(Context context, String path) {
        String str = "";
        try {
            AssetManager asset = context.getAssets();
            InputStream in = asset.open(path);
