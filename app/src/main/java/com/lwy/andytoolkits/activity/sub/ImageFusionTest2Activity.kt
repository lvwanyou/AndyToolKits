...
import com.dianping.video.view.gestureimgview.BlendGestureImageView4
import com.dianping.video.view.gestureimgview.DPTransformImageView
import com.lwy.andytoolkits.R
import com.lwy.andytoolkits.utils.PictUtils


class ImageFusionTest2Activity : AppCompatActivity() {
    companion object {
        const val REQUEST_CODE_GALLERY: Int = 1
    }

    private lateinit var img1: BlendGestureImageView3
    private lateinit var img2: BlendGestureImageView4
    private lateinit var seekBar: SeekBar

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_img_fusion_test2)
        initViews()
        openGallery()
    }
    ...
    private fun initViews() {
        ...
        img2 = findViewById<BlendGestureImageView4>(R.id.zoomRotateImg2)
